...
<header class="header">
   ...
   <div class="flex">
      ...
      <a href="admin_page.php" class="logo">Admin<span>Dasbor</span></a>
      ...
      <nav class="navbar">
         ...
         <a href="admin_setting.php">Pengaturan</a>
      </nav>
      ...
      <div class="account-box">
         <p>Identitas Pengguna : <span><?php echo $_SESSION['admin_name']; ?></span></p>
